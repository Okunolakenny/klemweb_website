...
target && getTargetedService(target);
...
data.addEventListener("click", dataAnalysisToggle);
software.addEventListener("click", softwareToggle);

function softwareToggle() {
...
function digitalmarketingToggle() {
  data2.classList.remove("active");
  ai2.classList.remove("active");
  software2.classList.remove("active");
  cs2.classList.remove("active");
...
CS.addEventListener("click", cyberToggle);

PD.addEventListener("click", productDesignToggle);

DM.addEventListener("click", digitalmarketingToggle);

// section working on ensuring the linnks stays at the services page when clicked
...
function getTargetedService(target) {
  switch (target) {
    case "se":
      softwareToggle();
      break;
